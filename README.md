...
本版本以“分娩产痛的同步陪伴疗程”为唯一主线：Vision Pro 面向产妇完成疗程准备、评估、沉浸治疗和本次回顾；`BreathIslandCompanion` iPadOS Target 提供家属陪伴与医护回看。

疗程码驱动的是确定性“演示同步模式”，不代表真实跨设备实时通信。心率、HRV、疼痛趋势、设备状态与任何疗效均为演示模拟数据；推荐能力是可解释的 MVP 规则引擎，不替代诊断、助产判断或临床治疗。
